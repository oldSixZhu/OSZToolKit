...
- (void)initSubviews {
    ...
    self.loadingView.center = CGPointMake(self.v_width/2.0, (self.v_height/2.0 - kFloat(20)));
...
- (LoadingAnimationView *)loadingView {
    if (!_loadingView) {
        _loadingView = [[LoadingAnimationView alloc] initWithFrame:CGRectMake(0, 0, 37, 37)];
    }
    return _loadingView;
}
